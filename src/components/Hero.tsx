...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] bg-gradient-to-br from-primary/90 to-primary flex items-center">
      <div 
        className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1482881497185-d4a9ddbe4151')] bg-cover bg-center mix-blend-overlay opacity-60"
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1482881497185-d4a9ddbe4151')" }}
      ></div>
